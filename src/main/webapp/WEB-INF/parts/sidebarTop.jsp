...
<div class="d-flex flex-row justify-content-between mt-2 p-1">
    ...
    %>
    <!-- Profile picture -->
    <div class="image mr-2"><img src="<%out.print(selected.getImageUrl());%>" class="thumbnail rounded-circle"/></div>
    <!-- Username -->
    ...
    <div class="dropdown-menu block-container">
        ...
        for (Account account : accounts.getArray()) {
            ...
            out.println("<div class=\"image mr-3\"><img src=\"" + account.getImageUrl() + "\" class=\"small-thumbnail rounded-circle\"/></div>");
            out.println("<span class=\"flex-fill align-self-center ");
